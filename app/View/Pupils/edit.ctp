...
<script>
  $(function() {
	...
	<div class="formsection">
		<?php echo '<h2>'.$this->html->image('icons/edit.png').' Edit Pupil</h2>';?>
	<?php
		...
		echo $this->Form->input('ethnicity',array('type'=>'select','options'=>$ethnicity,'default'=>$ethnicityDefault));
	?>
	</div>
	...
	<div class="formsection">
	<div class="ui-widget"><?php echo $this->Form->input('lea',array('type'=>'option','label'=>'Local Authority','default'=>$lea));?></div>
	<div class="ui-widget"><?php echo $this->Form->input('school',array('default'=>$school));?><p id="school-address"></p></div>
	</div>
	<div class="formsection">
	<?php
